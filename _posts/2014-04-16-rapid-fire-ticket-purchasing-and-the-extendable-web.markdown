...
```javascript
$(
  "#bpt_date_prices_1017125 .bpt_widget_price_table tr:nth-child(4) select"
).val(2);
...
6. Open a bunch of tabs in chrome and navigate them all to: [http://www.brownpapertickets.com/event/614931](http://www.brownpapertickets.com/event/614931)
